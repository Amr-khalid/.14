...
document.documentElement.style.setProperty("--color","black")
    ...
    document.body.style.cssText=`background:linear-gradient(346deg, #d6d4ff, white);`
    document.documentElement.style.setProperty("--color2","white")


    const buttons = document.querySelectorAll(".bb button");

buttons.forEach(button => {
    button.style.cssText = `margin: 3px
    /* letter-spacing: 3px; */
    width: 95%;
    background: linear-gradient(346deg, #44779e8f, #00000021);
    color: #ffffff16;
    height: 60px;
    font-size: 40px;
    box-shadow: 6px 5px 7px 1px rgb(0 0 0);
    border-radius: 24%;
    font-family: none;`; 
});
